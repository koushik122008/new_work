...
function init() {
    ...
    // Initialize shared geometries/materials after textures are ready
    initSharedResources();
...
function fireProjectile() {
    ...
    // Optimization: using pre-allocated shared geometry and material
    // to prevent GC pauses from frequent instantiations during the game loop.
...
function spawnEnemy() {
    ...
    // Core body
    // Optimization: using pre-allocated shared geometry and material
    // to prevent GC pauses from frequent instantiations.
