...
// Bolt: Pre-allocated shared geometries and materials to prevent GC overhead during high-frequency object spawning
...
function init() {
    ...
    // Bolt: Initialize shared geometries and materials after textures are ready
    sharedProjectileGeo = new THREE.CylinderGeometry(0.1, 0.1, 6, 8);
    sharedProjectileGeo.rotateX(Math.PI / 2); // Pre-rotate
...
function fireProjectile() {
    ...
    // Bolt: Use pre-allocated geometry and material instead of creating new ones
