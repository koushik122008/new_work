...
function init() {
    ...
    // Pre-allocate shared resources for performance
...
function fireProjectile() {
    // Projectile visual - glowing laser tracer using shared resources
...
function spawnEnemy() {
    ...
    // Core body using shared resources
    const core = new THREE.Mesh(sharedEnemyCoreGeo, sharedEnemyCoreMat);
    core.castShadow = true;
    enemy.add(core);

    // Armor plates/spikes using shared resources
    for (let i = 0; i < 4; i++) {
