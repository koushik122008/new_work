...
let sharedProjectileGeo;
let sharedProjectileMat;
let sharedEnemyCoreGeo;
let sharedEnemyCoreMat;
let sharedEnemySpikeGeo;
let sharedEnemySpikeMat;
...
function spawnEnemy() {
    ...
    // Core body
    // Reuse shared core geometry and material
    const core = new THREE.Mesh(sharedEnemyCoreGeo, sharedEnemyCoreMat);
    core.castShadow = true;
    enemy.add(core);

    // Armor plates/spikes
    // Reuse shared spike geometry and material
    for (let i = 0; i < 4; i++) {
