...
function init() {
    ...
    // ⚡ Bolt: Pre-allocate geometries and materials to avoid GC pauses during game loop
...
function fireProjectile() {
    // ⚡ Bolt: Reuse pre-allocated projectile geometry and material
...
function spawnEnemy() {
    ...
    // ⚡ Bolt: Reuse pre-allocated core geometry and material
    const core = new THREE.Mesh(sharedEnemyCoreGeo, sharedEnemyCoreMat);
    core.castShadow = true;
    enemy.add(core);

    // ⚡ Bolt: Reuse pre-allocated spike geometry and material
    for (let i = 0; i < 4; i++) {
