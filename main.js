...
// Shared Resources (Pre-allocated for performance)
...
function fireProjectile() {
    // Projectile visual - glowing laser tracer (using pre-allocated shared resources)
...
function spawnEnemy() {
    ...
    // Core body (using pre-allocated shared resources)
    const core = new THREE.Mesh(sharedEnemyCoreGeo, sharedEnemyCoreMat);
    core.castShadow = true;
    enemy.add(core);

    // Armor plates/spikes (using pre-allocated shared resources)
    for (let i = 0; i < 4; i++) {
